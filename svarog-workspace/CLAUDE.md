...
17. **News digest**: When the user asks for news ("новости", "дай новости", "что в мире", "news", "дайджест", "что нового в мире"), spawn a worker on project "news" with prompt "Gather and analyze current world news with financial focus. Output in Russian." Use emoji 📰 and userSummary "Сбор и анализ новостей". Do NOT use the general worker for news — always use project "news".
